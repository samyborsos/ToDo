...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="https://www.svgrepo.com/show/353985/laravel.svg">
</head>

<body class="h-full">
    <div class="min-h-full">
        @if(Session::has('success'))
            <div class="alert alert-success bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
                {{Session::get('success')}}
            </div>
        @endif
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <a href="/users/{{auth()->user()->id}}">
                                    <x-form-button class="mr-4">{{ auth()->user()->name }}</x-form-button>
                                </a>

                            </a>
                                @if(Auth::user()->admin == true)
                                    <a href="/admin">
                                        <x-form-button class="mr-4">Admin</x-form-button>
                                    </a>
                                @endif
